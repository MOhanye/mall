        ...
        $(function () {
            ...
            $(".shanchu").click(function () {
                $.ajax({
                    ...
                    type:"POST",
                    data:{
                        cid:$(this).siblings("input[name='cid']").val(),
                        sid:$(this).siblings("input[name='sid']").val()
                     /* cid:$(this),
                      sid:$(this).next("input[name='sid']").val()*/
//                      cid:$(".cid").val(),
//                        sid:$(".sid").val()
                    },
                    success:function (xscar) {
                        //console.log($(this).next("input[name='sid']")),
                       // console.log($(this).siblings("input[name='cid']"))
...
<div class="in-check">
    ...
    <c:forEach items="${requestScope.car}" var="car">
        ...
        <ul class="unit" name="${car.sid} ">
            <%--<input type="hidden" value="${car.cid}" class="cid">--%>
            <%--<input type="hidden" value="${car.sid}" class="sid">--%>


            <li><span>${fn:substring(car.username,0 ,15 )}</span></li>
            <li><span>${car.xinmoney}</span></li>
            <li><input type="number" value="${car.shuliang}" min="1"/></li>
            <li><span>${car.shuliang*car.xinmoney}</span></li>
