    ...
    <div class="single">
        <div class="col-md-9 top-in-single">
                ...
                <div class="flexslider">
                    ...
                    <ul class="slides">
                        <li data-thumb="images/si1.jpg">
                            <div class="thumb-image"> <img src="${ctx}${requestScope.xq.img}" data-imagezoom="true" class="img-responsive"> </div>
                        </li>
            ...
            <div class="col-md-7 single-top-in">
                <div class="single-para">
                    <h4>${requestScope.xq.sname}</h4>
                    <div class="para-grid">
                        <span  class="add-to">${requestScope.xq.xinoney}</span>
                        <a href="${ctx}/car?sid=${requestScope.xq.sid}&username=${sessionScope.username.username}" class="hvr-shutter-in-vertical cart-to">添加购物车</a>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="content-top-in">
                <div class="col-md-4 top-single">
                    <div class="col-md">
                        <img  src="${ctx}/static/img/pic8.jpg" alt="" />
                ...
                <div class="col-md-4 top-single">
                    <div class="col-md">
                        <img  src="${ctx}/static/img/pic9.jpg" alt="" />
                        <div class="top-content">
                            <h5>Mascot Kitty - White</h5>
                            <div class="white">
                                <a href="#" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">ADD TO CART</a>
                ...
                <div class="col-md-4 top-single-in">
                    <div class="col-md">
                        <img  src="${ctx}/static/img/pic10.jpg" alt="" />
                        <div class="top-content">
                            <h5>Mascot Kitty - White</h5>
                            <div class="white">
                                <a href="#" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">ADD TO CART</a>
        ...
        <div class="col-md-3">
            ...
            <div class="single-bottom">
                <h4>Product Categories</h4>
                <div class="product">
                    <img class="img-responsive fashion" src="${ctx}/static/img/st1.jpg" alt="">
                ...
                <div class="product">
                    <img class="img-responsive fashion" src="${ctx}/static/img/st2.jpg" alt="">
                    <div class="grid-product">
                        <a href="#" class="elit">Consectetuer adipiscing elit</a>
                        <span class="price price-in"><small>$500.00</small> $400.00</span>
                    </div>
                ...
                <div class="product">
                    <img class="img-responsive fashion" src="${ctx}/static/img/st3.jpg" alt="">
                    <div class="grid-product">
                        <a href="#" class="elit">Consectetuer adipiscing elit</a>
                        <span class="price price-in"><small>$500.00</small> $400.00</span>
                    </div>
